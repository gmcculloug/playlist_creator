...
import YouTubeAuth from './YouTubeAuth.jsx';
...
function App() {
  ...
  const checkTrelloConfig = () => {
    const trelloBoardIds = import.meta.env.VITE_TRELLO_BOARD_IDS;
      ...
      <header className="App-header">
        ...
        <div className="platform-selector-top">
          <button 
            ...
            title={!spotifyConfigured ? 'Spotify not configured. Set VITE_SPOTIFY_CLIENT_ID and SPOTIFY_CLIENT_SECRET in .env file' : ''}
          >
          ...
          <button 
            ...
            title={!trelloConfigured ? 'Trello not configured. Set VITE_TRELLO_BOARD_IDS in .env file' : ''}
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
